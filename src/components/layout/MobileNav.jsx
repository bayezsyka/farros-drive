...
function MobileNav({ items }) {
  return (
    <nav className="fixed inset-x-4 bottom-4 z-40 rounded-[28px] border border-white/80 bg-white/90 p-2 shadow-[0_20px_45px_-28px_rgba(12,37,59,0.35)] backdrop-blur xl:hidden">
