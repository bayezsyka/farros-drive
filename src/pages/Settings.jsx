...
const settingsRows = [
  ...
  { label: 'Status backend', value: 'Belum tersambung', icon: Server },
]
    ...
    <div className="grid gap-4 xl:grid-cols-[minmax(0,1.3fr)_minmax(320px,0.9fr)]">
      ...
      <Card className="p-6">
        ...
        <p className="mt-4 text-sm leading-7 text-farros-ink">
          Fase ini masih UI. Fase berikutnya akan membuat Go API untuk membaca dan mengelola berkas asli di
          `/srv/drive`.
        </p>
